...
const UiCard = () => {
  ...
  return (
    <div className="bg-white/30 backdrop-blur-md border border-white/10 rounded-lg shadow-lg md:max-w-lg max-w-[330px] mx-auto p-10 flex md:flex-row flex-col gap-10">
